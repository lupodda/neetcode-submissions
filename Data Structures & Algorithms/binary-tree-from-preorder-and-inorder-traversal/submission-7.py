...
class Solution:
    def buildTree(self, preorder: List[int], inorder: List[int]) -> Optional[TreeNode]:
        ...
        # limit tells us when the current subtree ends in inorder traversal
        ...
        #MAIN TAKEAWAIS
        #keep in mind the main three concepts: what preorder, inorder and limit tell us
        # dont forget the nonlocal variables
        # the two main base cases to know when a subtree is finisdhed and when the full tree is finished
