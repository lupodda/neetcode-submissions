class Solution:
    ...
    def decode(self, s: str) -> List[str]:
        ...
        # Always think to edge cases
        # Substrings -> two pointers
        # for index updates always look at the examples
        # while loop is useful if i don't want to look over each element
        # Try to be proactive and not to give up
