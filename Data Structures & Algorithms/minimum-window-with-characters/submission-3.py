...
class Solution:
    def minWindow(self, s: str, t: str) -> str:
        ...
        # MAIN TAKEAWAYS
        # remeber to count the frequencies
        # rather then storing the shortest substring store the limits of it
        # when shirnking check if the removed elemet is a char in t and if the frequences still match because we could remove a char but the freq in the window is still valid
